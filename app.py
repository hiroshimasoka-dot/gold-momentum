...
fig.add_shape(type="line", x0=df.index[0], x1=df.index[-1], y0=rsi_ob, y1=rsi_ob, line=dict(color="#FF2D5566", width=1, dash="dash"), row=2, col=1)
fig.add_shape(type="line", x0=df.index[0], x1=df.index[-1], y0=rsi_os, y1=rsi_os, line=dict(color="#00E5A066", width=1, dash="dash"), row=2, col=1)
fig.add_shape(type="line", x0=df.index[0], x1=df.index[-1], y0=50, y1=50, line=dict(color="#1e2535", width=1, dash="dot"), row=2, col=1)
...
fig.add_shape(type="line", x0=df.index[0], x1=df.index[-1], y0=0, y1=0, line=dict(color="#1e2535", width=1), row=3, col=1)
