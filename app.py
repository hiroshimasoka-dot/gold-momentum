...
# High/Low labels via shapes
fig.add_annotation(x=df.index[-1], y=max_p, text=f"高値 ${max_p:.2f}", showarrow=False, font=dict(color="#FF2D55", size=10), xref="x", yref="y", xanchor="right")
fig.add_annotation(x=df.index[-1], y=min_p, text=f"安値 ${min_p:.2f}", showarrow=False, font=dict(color="#00E5A0", size=10), xref="x", yref="y", xanchor="right")
